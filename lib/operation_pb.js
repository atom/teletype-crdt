...
goog.exportSymbol('proto.Operation.Deletion.OffsetRange', null, global);
...
proto.Operation.Deletion = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.Operation.Deletion.repeatedFields_, null);
};
 ...
 * @const
 */
proto.Operation.Deletion.repeatedFields_ = [2];
...
proto.Operation.Deletion.toObject = function(includeInstance, msg) {
  var f, obj = {
    opId: (f = msg.getOpId()) && proto.OperationId.toObject(includeInstance, f),
    offsetRangesList: jspb.Message.toObjectList(msg.getOffsetRangesList(),
    proto.Operation.Deletion.OffsetRange.toObject, includeInstance)
  };
...
proto.Operation.Deletion.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.Operation.Deletion.OffsetRange;
      reader.readMessage(value,proto.Operation.Deletion.OffsetRange.deserializeBinaryFromReader);
      msg.addOffsetRanges(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.Operation.Deletion.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getOffsetRangesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.Operation.Deletion.OffsetRange.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.Operation.Deletion.OffsetRange = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.Operation.Deletion.OffsetRange, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.Operation.Deletion.OffsetRange.displayName = 'proto.Operation.Deletion.OffsetRange';
}
 ...
 * @return {!Object}
 */
proto.Operation.Deletion.OffsetRange.prototype.toObject = function(opt_includeInstance) {
  return proto.Operation.Deletion.OffsetRange.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Operation.Deletion.OffsetRange} msg The msg instance to transform.
 * @return {!Object}
 */
proto.Operation.Deletion.OffsetRange.toObject = function(includeInstance, msg) {
  var f, obj = {
    opId: (f = msg.getOpId()) && proto.OperationId.toObject(includeInstance, f),
    startOffset: (f = msg.getStartOffset()) && proto.Point.toObject(includeInstance, f),
    endOffset: (f = msg.getEndOffset()) && proto.Point.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Operation.Deletion.OffsetRange}
 */
proto.Operation.Deletion.OffsetRange.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Operation.Deletion.OffsetRange;
  return proto.Operation.Deletion.OffsetRange.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Operation.Deletion.OffsetRange} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Operation.Deletion.OffsetRange}
 */
proto.Operation.Deletion.OffsetRange.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Operation.Deletion.OffsetRange.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Operation.Deletion.OffsetRange.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Operation.Deletion.OffsetRange} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.Operation.Deletion.OffsetRange.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOpId();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.OperationId}
 */
proto.Operation.Deletion.OffsetRange.prototype.getOpId = function() {
  return /** @type{?proto.OperationId} */ (
    jspb.Message.getWrapperField(this, proto.OperationId, 1));
};
...
/** @param {?proto.OperationId|undefined} value */
proto.Operation.Deletion.OffsetRange.prototype.setOpId = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.Operation.Deletion.OffsetRange.prototype.clearOpId = function() {
  this.setOpId(undefined);
};
 ...
 * @return {!boolean}
 */
proto.Operation.Deletion.OffsetRange.prototype.hasOpId = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional Point start_offset = 2;
 * @return {?proto.Point}
 */
proto.Operation.Deletion.OffsetRange.prototype.getStartOffset = function() {
  return /** @type{?proto.Point} */ (
...
/** @param {?proto.Point|undefined} value */
proto.Operation.Deletion.OffsetRange.prototype.setStartOffset = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.Operation.Deletion.OffsetRange.prototype.clearStartOffset = function() {
 ...
 * @return {!boolean}
 */
proto.Operation.Deletion.OffsetRange.prototype.hasStartOffset = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional Point end_offset = 3;
 * @return {?proto.Point}
 */
proto.Operation.Deletion.OffsetRange.prototype.getEndOffset = function() {
  return /** @type{?proto.Point} */ (
...
/** @param {?proto.Point|undefined} value */
proto.Operation.Deletion.OffsetRange.prototype.setEndOffset = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.Operation.Deletion.OffsetRange.prototype.clearEndOffset = function() {
 ...
 * @return {!boolean}
 */
proto.Operation.Deletion.OffsetRange.prototype.hasEndOffset = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Array.<!proto.Operation.Deletion.OffsetRange>}
 */
proto.Operation.Deletion.prototype.getOffsetRangesList = function() {
  return /** @type{!Array.<!proto.Operation.Deletion.OffsetRange>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Operation.Deletion.OffsetRange, 2));
};


/** @param {!Array.<!proto.Operation.Deletion.OffsetRange>} value */
proto.Operation.Deletion.prototype.setOffsetRangesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.Operation.Deletion.OffsetRange=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Operation.Deletion.OffsetRange}
 */
proto.Operation.Deletion.prototype.addOffsetRanges = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.Operation.Deletion.OffsetRange, opt_index);
};


proto.Operation.Deletion.prototype.clearOffsetRangesList = function() {
  this.setOffsetRangesList([]);
};
