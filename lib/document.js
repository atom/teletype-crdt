...
class Document {
  ...
  replicate (siteId) {
    ...
    replica.integrateOperations(this.operations)
    return replica
  }
  ...
  setTextInRange (start, end, text, options) {
    ...
    if (!options || options.pushToHistory !== false) {
  ...
  undo () {
    ...
    if (spliceIndex != null) {
      ...
      let markers = markersSnapshot ? this.markersFromSnapshot(markersSnapshot) : null
