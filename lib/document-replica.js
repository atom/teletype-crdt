...
class DocumentReplica {
  constructor (siteId) {
    ...
    const firstSegment = {opId: {site: 0, seq: 0}, offset: ZERO_POINT, pos: 0, text: '', extent: ZERO_POINT, nextSplit: null, deletions: new Set()}
    this.splitTreesByOpId.set(opIdToString(firstSegment.opId), new SplitTree(firstSegment))

    const lastSegment = {opId: {site: 0, seq: 1}, offset: ZERO_POINT, pos: 1, text: '', extent: ZERO_POINT, nextSplit: null, deletions: new Set()}
