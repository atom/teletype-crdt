...
class DocumentReplica {
        ...
        for (let markerId in updatesByMarkerId) {
          ...
          if (markerUpdate) {
            if (markerUpdate.range && !this.canTranslateRemoteRange(markerUpdate.range)) {
              ...
              this.updateMarker(markerUpdates, siteId, layerId, markerId, markerUpdate)
            }
          } else {
        ...
        if (deferredUpdatesByLayerId) {
          ...
          if (deferredUpdatesByMarkerId) {
            ...
            if (deferredUpdate && this.canTranslateRemoteRange(deferredUpdate.range)) {
              this.updateMarker(markerUpdates, siteId, layerId, markerId, deferredUpdate)
            }
          }
        }
      })
  ...
  updateMarker (markerUpdates, siteId, layerId, markerId, update) {
    ...
    markerUpdates[siteId][layerId][markerId].range = {
